...
$area = isset($_POST['area']) ? strtolower($_POST['area']) : null;
$housetype = $_POST['housetype'] ?? null;
$preferredfor = $_POST['preferredfor'] ?? null;
$parkingstatus = isset($_POST['parkingstatus']) ? strtolower($_POST['parkingstatus']) : null;
...
let closebutton = document.querySelector('.close-button-profile');
   ...
   let container = document.querySelector('.main-container-profile');
