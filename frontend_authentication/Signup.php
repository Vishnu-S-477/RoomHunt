...
<body>
    <form class="main-container" action = "../backend_authentication/backendsignup.php" method = "post" enctype="multipart/form-data">
        ...
        <input type="date" class="date" name="Date-of-Birth" value = "<?php echo (htmlspecialchars(isset($dob)?$dob:'' ));?>" required>
        <input type="text" class="userid" name="userid" value = "<?php echo (htmlspecialchars(isset($userid)?$userid:'' ));?>" placeholder="Enter 4to8 letter" required>
